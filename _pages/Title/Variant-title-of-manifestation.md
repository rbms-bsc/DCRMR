...
<a name="1.25.4.3">1.25.4.3</a> **Title proper in nonroman script**. If nonroman text has been transcribed within the first five words of the [Title proper](/DCRMR/title/Title-proper), provide additional title access for a romanized version of the [Title proper](/DCRMR/title/Title-proper) using the [ALA-LC Romanization Tables](https://www.loc.gov/catdir/cpso/roman.html){:target="_blank"} (see [0.4.2](/DCRMR/general-rules/Language-and-script-of-the-description/#042-romanization)).
...
<a name="1.25.4.96">1.25.4.96</a> **Title proper with transposed elements (optional)**. If an element appearing before the [Title proper](/DCRMR/title/Title-proper) has been transposed, provide additional title access for the element or for the title inclusive of the preceding element. If the preceding element has not been transposed, so that the [Title proper](/DCRMR/title/Title-proper) includes it, provide additional title access for the title without the preceding element (see [1.21.3.1](/DCRMR/title/Title-proper/#1.21.3.1) and [0.5.94](/DCRMR/general-rules/Transcription/#0594-order-and-transposition)).

<a name="1.25.4.97">1.25.4.97</a> **Title proper inclusive of an alternative title (optional)**. Provide additional title access for an alternative title (see [1.21.4.3](/DCRMR/title/Title-proper/#1.21.4.3)).
