...
<a name="1.25.4.5">1.25.4.5</a> **Latin title proper with final capital I representing ii**. If any of the first five words in the [Title proper](/DCRMR/title/Title-proper) is a Latin word with a final capital **I** that has been retained in the transcription, provide additional title access for the form of title proper with the final capital **I** converted to **ii** (see [0.5.24](/DCRMR/general-rules/Transcription/#0524-final-capital-i-in-latin)).
...
<a name="1.25.4.8">1.25.4.8</a> **Variant spellings involving spacing**. If any variant or archaic spacing has been transcribed in the first five words of the [Title proper](/DCRMR/title/Title-proper), provide additional title access for the form of title with modern spacing (see [0.5.44](/DCRMR/general-rules/Transcription/#0544-variant-spellings)).
...
<a name="1.25.4.9">1.25.4.9</a> **Title proper with initials, etc. (optional)**. If the [Title proper](/DCRMR/title/Title-proper) contains initials, initialisms, or acronyms with internal spaces, provide additional title access for the title with the spaces closed up. Conversely, if the [Title proper](/DCRMR/title/Title-proper) contains initials, initialisms, or acronyms without internal spaces, provide title access for the title with the spaces inserted (see [0.5.45](/DCRMR/general-rules/Transcription/#0545-initials-etc)).

<a name="1.25.4.91">1.25.4.91</a> **Title proper with an interpolated blank**. If a blank space intended to be filled in manuscript has been transcribed within the first five words of the [Title proper](/DCRMR/title/Title-proper) as the word “blank” enclosed in square brackets, provide additional title access for the form of Title proper without the interpolated blank (see [0.5.64](/DCRMR/general-rules/Transcription/#0564-blank-spaces-intended-for-completion)).
...
<a name="1.25.4.93">1.25.4.93</a> **Title proper with non-standard orthography (optional)**. If the [Title proper](/DCRMR/title/Title-proper) contains words spelled according to older or non-standard orthographic conventions, provide additional title access for the title spelled according to modern orthography.

<a name="1.25.4.94">1.25.4.94</a> **Title proper with approximated letters**. If any of the first five words in the [Title proper](/DCRMR/title/Title-proper) contains two letters used to approximate a third letter, provide additional title access for the form of Title proper with the letters transcribed as set (see [0.5.74](/DCRMR/general-rules/Transcription/#0574-turned-and-approximated-letters)).
...
<a name="1.25.4.95">1.25.4.95</a> **Title proper with special marks of contraction (optional)**. If the [Title proper](/DCRMR/title/Title-proper) contains a cataloger’s expansions of special marks of contraction, provide additional title access for the title as it appears in the manifestation, ignoring the marks of contraction. In addition, provide title access for the transcribed form of the [Title proper](/DCRMR/title/Title-proper), but without the square brackets (see [0.5.16](/DCRMR/general-rules/Transcription/#0516-brevigraphs) and [0.5.82](/DCRMR/general-rules/Transcription/#0582-abbreviations-and-contractions)).
...
<a name="1.25.4.96">1.25.4.96</a> **Title proper with transposed elements (optional)**. If an element appearing before the [Title proper](/DCRMR/title/Title-proper) has been transposed, provide additional title access for the element or for the title inclusive of the preceding element. If the preceding element has not been transposed, so that the [Title proper](/DCRMR/title/Title-proper) includes it, provide additional title access for the title without the preceding element (see [1.21.X.X](/DCRMR/title/Title-proper/#1.21.X.X) and [0.5.94](/DCRMR/general-rules/Transcription/#0594-order-and-transposition)).

<a name="1.25.4.97">1.25.4.97</a> **Title proper inclusive of an alternative title (optional)**. Provide additional title access for an alternative title (see [1.21.X.X](/DCRMR/title/Title-proper/#1.21.X.X)).
...
<a name="1.25.4.991">1.25.4.991</a> **First line of printing on single-sheet manifestations (optional)**. Provide additional access for at least the first five words in the first line of printing on single-sheet manifestations if the words have not been transcribed as part of the [Title proper](/DCRMR/title/Title-proper) (see [1.21.X.X](/DCRMR/title/Title-proper/#1.21.X.X)).
...
<a name="1.25.4.993">1.25.4.993</a> **Variant titles of a collection (optional)**. Record variant titles by which a collection may be known if they differ substantially from the [Title proper](/DCRMR/title/Title-proper) and provide useful access points. If most or all of the items in the collection have the same title information and it is considered important, make an added entry for the title.
