...
<a name="3.21.6.1">3.21.6.1</a> Omit statements relating to a substantially unchanged impression or state from the transcription without using the mark of omission.  Record such statements as [Note on item](/DCRMR/notes-on-items/Note-on-item/) if considered important (see [10.20.4](https://rbms-bsc.github.io/DCRMR/notes-on-items/Note-on-item/#10204-statements-relating-to-a-substantially-unchanged-impression-or-state)).
