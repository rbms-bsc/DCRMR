...
*Exception*: For prints without title pages, see [3.21.42.Y.Y](/DCRMR/edition/Edition-statement/#32142yy-supplied-and-devised-edition-statements-for-printed-still-images)).
...
<a name="3.21.42.2.Y.Y">3.21.42.2.Y.Y</a> *Optionally*, even when transcribed information in the body of the description is sufficient to disambiguate states, include an Edition statement found in a reference source.

>**Example:** 
>Title proper: <CITE>Effigies Paraselci medici celeberrimi</CITE>  
>Statement of responsibility relating to title proper: <CITE>P.P. Rub pinxit ; R. Gaywood fecit</CITE>  
>Edition statement: <CITE>[State i]</CITE>  
>>(*Comment*: In state ii, "W. Hollar sculp." replaced "R. Gaywood fecit" in the Statement of responsibility relating to title proper)
