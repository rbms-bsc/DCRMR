...
<a name="8.23.3.1">8.23.3.1</a> For general instructions on constructing item specific notes (see [Note on item](/DCRMR/notes-on-items/Note-on-item/), [8.20.X.X](/DCRMR/Notes-on-item/Note-on-item/#8.20.X.X)).
