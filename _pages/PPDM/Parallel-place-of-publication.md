...
<a name="4.202.3.2">4.202.3.2</a> Transcribe remaining places of publication as parallel places of publication.  If a parallel place of publication is from a different source than the [place of publication](/DCRMR/ppdm/Place-of-publication/), make a note on publication statement if considered important for identification (see [4.206.7.1](/DCRMR/ppdm/Note-on-publication-statement/#4.206.7.1)).
