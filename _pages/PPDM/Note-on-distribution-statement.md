...
<a name="5.285.36.8">5.285.36.8</a> Record the date of each volume in a note on distribution statement if considered important. Such a note is particularly useful when the order of distribution does not correspond to the order of the volume numeration (see [Date of distribution](/DCRMR/ppdm/Date-of-distribution/), [5.28.35.2](/DCRMR/ppdm/Date-of-distribution/#5.28.35.2)).
