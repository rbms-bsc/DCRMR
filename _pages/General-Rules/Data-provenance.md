...
If describing an exemplar of a manifestation known to be imperfect, and details of a perfect (or more perfect) exemplar can be determined, base the description on the perfect exemplar. Do not use square brackets to record information present in the perfect exemplar but absent in the imperfect exemplar. Details of a perfect (or more perfect) exemplar may be determined by examining additional items, by examining facsimiles of perfect copies, or by referring to reliable descriptions in other sources. As appropriate, cite the source used for the description (see [7.223.X.X](/DCRMR/other-notes/Manifestation-described-in/#7.223.4.1)). Make a local note describing the imperfection of the item in hand (see [10.21.3.2](/DCRMR/notes-on-items/Modification-of-item/#10.21.3.2)).
